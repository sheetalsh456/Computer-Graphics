...
/* void show_screen( );
 ...
 void apply_z_shearing(int[5][3],constfloat,constfloat);
...
void apply_z_shearing(int edge_points[5][3],float a,float b)
    {
	int count;
 ...
 int main( )
    {
     ...
     draw_pyramid(pyramid);
       ...
       setcolor(15);
       //settextstyle(0,0,1);
     outtextxy(50,415,"*** Press any key to see the 3D Shearing along z-axis.");

       apply_z_shearing(pyramid,0.5,0.5);
